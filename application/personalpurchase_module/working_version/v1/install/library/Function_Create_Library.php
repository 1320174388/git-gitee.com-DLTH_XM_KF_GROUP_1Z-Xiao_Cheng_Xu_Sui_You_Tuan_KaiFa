 ...
 */
Route::{$dataTypeL}(
    ':v/personalpurchase_module/{$name}_route',
    'personalpurchase_module/:v.controller.{$Name}Controller/{$name}{$DataTypeL}'
);
";
        // 判断文件是否存在
        if(file_exists("../route/personalpurchase_route_v1_api.php")){
            file_put_contents(
                '../route/personalpurchase_route_v1_api.php',
                $String, FILE_APPEND
            );
        }
    }
